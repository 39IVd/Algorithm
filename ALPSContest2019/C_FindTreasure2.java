...
//        Queue<Point_Treasure2> q = new LinkedList();
//        q.add(new Point_Treasure2(1, 1, 0));
//        int strcnt = 0;
//        int nx=0, ny=0, nk=0;
//        while(!q.isEmpty()) {
//            Point_Treasure2 pt = q.poll();
//            visited[pt.x][pt.y] = 1;
//            nk = pt.k;
...
//                            visited[px][py]!=1) {
//                        q.add(new Point_Treasure2(px, py, nk));
//                    }
//                    if(matrix[px][py].equals(s[strcnt])&&
//                            visited[px][py]==1) {
//                        q.add(new Point_Treasure2(px, py, nk));
